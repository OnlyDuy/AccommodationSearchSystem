...
using Shouldly;
using Xunit;
using AccommodationSearchSystem.Sessions;

namespace AccommodationSearchSystem.Tests.Sessions
{
    public class SessionAppService_Tests : AccommodationSearchSystemTestBase
    {
