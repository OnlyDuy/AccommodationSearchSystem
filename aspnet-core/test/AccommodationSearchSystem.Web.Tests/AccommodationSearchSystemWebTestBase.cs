...
{
    public abstract class AccommodationSearchSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AccommodationSearchSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AccommodationSearchSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AccommodationSearchSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AccommodationSearchSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AccommodationSearchSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AccommodationSearchSystemDbContext, Task<T>> func)
        {
            T result;
