...
namespace AccommodationSearchSystem.Migrations
{
    ...
    [Migration("20240503044753_AddTablePayment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccommodationSearchSystem.Entity.NotificationDating", b =>
                {
                    ...
                    b.Property<string>("NotiDatingName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AccommodationSearchSystem.Entity.UserComments", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AccommodationSearchSystem.Entity.VnPayments", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AccommodationSearchSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AccommodationSearchSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AccommodationSearchSystem.Entity.UserComments", b =>
                {
                    b.HasOne("AccommodationSearchSystem.Entity.Post", null)
                        .WithMany("UserCommentes")
