...
namespace AccommodationSearchSystem.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(AccommodationSearchSystemDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new AccommodationSearchSystemAuthorizationProvider())
            ...
            if (adminUser == null)
            {
                adminUser = User.CreateTenantAdminUser(_tenantId, "admin@defaulttenant.com", "0123456789");
