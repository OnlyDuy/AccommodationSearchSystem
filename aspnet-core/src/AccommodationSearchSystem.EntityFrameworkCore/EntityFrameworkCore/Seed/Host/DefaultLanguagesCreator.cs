...
namespace AccommodationSearchSystem.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AccommodationSearchSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AccommodationSearchSystemDbContext context)
        {
            _context = context;
        }
