...
using Abp.UI;
using AccommodationSearchSystem.Authentication.External;
using AccommodationSearchSystem.Authentication.JwtBearer;
...
namespace AccommodationSearchSystem.Controllers
{
    ...
    public class TokenAuthController : AccommodationSearchSystemControllerBase
    {
