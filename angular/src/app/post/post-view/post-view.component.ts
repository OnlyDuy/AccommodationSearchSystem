...
export class PostViewComponent extends AppComponentBase implements OnInit {
  ...
  ngOnInit() {
    ...
    console.log(this.dataPriceCategory);
  }
  ...
  onChangepriceCategoris(param: any) {
    this.dataPriceCategory = param;
    console.log(this.dataPriceCategory);
  }
