...
import { GetPostForLikeDto, GetPostForViewDto, ViewPostServiceProxy } from '@shared/service-proxies/service-proxies';

@Component({
  selector: 'app-home-user-like',
  templateUrl: './home-user-like.component.html',
  styleUrls: ['./home-user-like.component.css'],
  providers: [ViewPostServiceProxy],
})
export class HomeUserLikeComponent extends AppComponentBase implements OnInit {
