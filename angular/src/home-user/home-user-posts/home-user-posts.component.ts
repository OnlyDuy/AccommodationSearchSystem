...
@Component({
  ...
  templateUrl: './home-user-posts.component.html',
  styleUrls: ['./home-user-posts.component.css'],
  providers: [ViewPostServiceProxy]
})
export class HomeUserPostsComponent extends AppComponentBase implements OnInit {
